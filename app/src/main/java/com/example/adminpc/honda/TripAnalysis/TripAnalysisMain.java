package com.example.adminpc.honda.TripAnalysis;
...
public class TripAnalysisMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trip_analysis_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(TripAnalysisMain.this,MainActivity.class);
            startActivity(i);
            finish();
            return true;
        }
        if (id == R.id.action_reset) {
            Intent i = new Intent(TripAnalysisMain.this,SplashActivity.class);
            startActivity(i);
            finish();
            return true;
        }
    ...
    public void getInit(int video,int duration) {
        video_player_view = (VideoView) findViewById(R.id.video_tripana);
