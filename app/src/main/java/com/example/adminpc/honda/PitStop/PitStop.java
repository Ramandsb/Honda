...
public class PitStop extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(PitStop.this,MainActivity.class);
            startActivity(i);
            finish();
            return true;
        }
        ...
        if (id == R.id.action_reset) {
            Intent i = new Intent(PitStop.this,SplashActivity.class);
            startActivity(i);
            finish();
            return true;
        }
