...
public class SelectCar extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(SelectCar.this,MainActivity.class);
            startActivity(i);
            finish();
            return true;
        }
        if (id == R.id.action_reset) {
            Intent i = new Intent(SelectCar.this,SplashActivity.class);
            startActivity(i);
            finish();
            return true;
        }
    ...
    public void getInit() {
        ...
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.request_enquiry);
...
//        mHandler.postDelayed(loadHomeActivity, 34000);
    }
