...
public class SharePage extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(SharePage.this,MainActivity.class);
            startActivity(i);
            finish();
            return true;
        }
        ...
        if (id == R.id.action_reset) {
            Intent i = new Intent(SharePage.this,SplashActivity.class);
            startActivity(i);
            finish();
            return true;
        }
    ...
    public void getInit() {
        ...
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.share_s);
        video_player_view.setVideoURI(uri);
        video_player_view.start();
        mHandler.removeCallbacks(loadHomeActivity);
        mHandler.postDelayed(loadHomeActivity, 20000);
    }
